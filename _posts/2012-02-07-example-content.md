...
- Maxim1. Network designs are based on Politics, Money, and The right way to do it—in that order.
- Maxim2. The only valid reasons to change aproperly sized pro-duction network are Simplification, Standardization, and Stabilization.
- Maxim3. IT projects that lower costs, increase performance or capacity, or increase reliability.
