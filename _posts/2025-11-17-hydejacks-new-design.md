...
비용결제도 Tier-Group&후불에 대해서 미리 인지하고 처리를 해야하고 도움말도 있지만 뭔가 꽤 복잡해보인다.[결제정보](https://ai.google.dev/gemini-api/docs/billing?hl=ko) *"무엇인가? 사전이해가 많이 필요하다"* 물론 개인적인 시각의 차이일수 있다. 하지만 User친화적인 감각은 아닌 듯 하다. 
